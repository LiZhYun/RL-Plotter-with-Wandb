...
COLORS = ['#e41a1c', '#377eb8', '#984ea3', '#ff7f00', '#fbfba1', '#c39797', '#0766AD', '#D2DE32']
#, '10gen_protoss 10v11', '10gen_terran 10v10', '10gen_terran 10v11'
main_envs = [
            '10gen_protoss 5v5', '10gen_protoss 10v10',
...
algos = ['AengMixer', 'MAPPO', 'HAPPO', 'MAVEN', 'MAT', 'MAT-Dec', 'MACPF', 'MAPPO_FULL']
...
def plot(df, key='eval_win_rate'):
    ...
    for idx, scenario in enumerate(main_envs):
        ...
        if idx == 0:
            hue_order = ['AengMixer', 'MAPPO', 'HAPPO', 'MAVEN', 'MAT', 'MAT-Dec', 'MACPF', 'MAPPO_FULL']
        ...
        if idx % ncol == 0:
            ...
            ax.set_ylabel('')
    plt.tight_layout()
    plt.savefig(f'{save_path}/SMAC_abl.pdf')
    plt.show()
